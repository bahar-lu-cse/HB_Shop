    ...
    <div class="container_12">
                ...
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            <li >Hello <span style="color: #ffffff; font-style: bold;"><?php echo Session::get('adminName')?></span></li>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class=""><a href="../"><span><i class="fas fa-tachometer-alt"></i> Visit Home Page</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>
