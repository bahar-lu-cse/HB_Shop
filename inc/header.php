...
<body>
			...
			<div class="header_top_right">
			    <div class="search_box">
				    <form action="searchAction.php" method="POST">
						...
						<input class="" type="text" placeholder="Search for Products" name="search_text"><input class="" type="submit" value="SEARCH" name="search">
				    </form>
			    </div>
	...
	<div class="menu" style="margin-top:5px; height: 50px;">
	<!-- <nav class="navbar navbar-expand navbar-light bg-white topbar shadow" style="height:30px;"> -->
		<ul class="dc_mm-orange" style="box-shadow: 4px 4px 4px #9d9d9d;" >  
			<!-- //class="dc_mm-orange" -->
