    ...
    <div class="content">
    	<div class="section group">
 			<div class='payment'>
 				...
 				<a href="paymentoffline.php"><i class="fas fa-money-bill-wave white"></i> Cash On Delivery</a>
 				<a href="digitalpayment.php?orderId=order"><i class="fas fa-money-bill-wave white"></i> Digital Payment</a>
 				
         
 			</div>
    		<div class='back'>
    			<a href="cart.php"><i class="fas fa-backspace white"></i> Go Back</a>
    		</div>
 		</div>
 	</div>
</div>
